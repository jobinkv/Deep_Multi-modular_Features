...
def cross_entropy(inputs, target, weight=None, ignore_index=-100, reduction='mean',
    ...
    if _is_long(target): # for integer labels
...
class CrossEntropyLossSM(nn.CrossEntropyLoss):
    """CrossEntropyLossSM - with ability to recieve distrbution as targets, and optional label smoothing"""

    def __init__(self, weight=None, ignore_index=-100, reduction='mean', smooth_eps=None, smooth_dist=None, from_logits=True):
        super(CrossEntropyLossSM, self).__init__(weight=weight,
