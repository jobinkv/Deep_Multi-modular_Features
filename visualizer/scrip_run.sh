...
mkdir -p /ssd_scratch/cvit/pyTorchPreTrainedModels
cd /ssd_scratch/cvit/jobinkv
# geting the image
rsync -avz jobinkv@10.2.16.142:/mnt/3/scriptIdentificationDataset/* /ssd_scratch/cvit/jobinkv
...
python main.py --trainedModel /ssd_scratch/cvit/pyTorchPreTrainedModels/resnext101script.pth\
 --dataset script -k 20 -g 64 -c 256 
